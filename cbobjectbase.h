...
public:
    ...
    //! This function is only available to apps, not bots. Return data needed to display the info panel for a user.\n The return value is a key-value set with a template key. Depending on the template chosen, additional keys should be passed in. For more information, see Available Templates\n The user param is no longer supported and will be undefined.\li 3_rows_of_labels\li 3_rows_11_21_31\li 3_rows_12_21_31\li 3_rows_12_22_31
